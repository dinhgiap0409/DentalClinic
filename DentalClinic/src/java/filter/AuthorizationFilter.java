...
//@WebFilter(filterName = "AuthorizationFilter", urlPatterns = { "/receptionist/*", "/admin/*", "/doctor/*", "/patient/*",
//        "/profile" })
...
//        else if (path.startsWith("/patient") || path.equals("/profile")) {
//            // Trang profile có thể được truy cập bởi nhiều vai trò, nhưng ở đây ta giới hạn
//            // cho Patient
//            // Hoặc có thể cho phép tất cả các vai trò đã đăng nhập
//            if (user != null) { // Chỉ cần đăng nhập là được vào profile
//                authorized = true; // Nếu đúng, cấp quyền truy cập.
//            }
//        }
//
