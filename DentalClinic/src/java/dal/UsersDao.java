...
public class UsersDao extends DBContext {
    ...
    """;
        ...
        try (Connection connect = new DBContext().connection; PreparedStatement ps = connect.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            try (ResultSet rs = ps.getGeneratedKeys()) {
                ...
                //  Nếu là bệnh nhân, tạo luôn bản ghi Patients tương ứng
                if ("Patient".equalsIgnoreCase(user.getRole())) {
                    createPatientForUser(newUserId, connect);
                }
 ...
 private void createPatientForUser(int userId, Connection conn) throws SQLException {
